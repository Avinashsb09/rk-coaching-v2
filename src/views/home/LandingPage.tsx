    ...
    <div className="space-y-16 py-8">
      ...
      <section className="relative px-4 text-center max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 max-w-2xl mx-auto mb-6">
          {/* Quiz Arena Card */}
          <div className="flex-1 p-5 border border-indigo-500/25 rounded-3xl bg-slate-900/60 dark:bg-slate-950/40 backdrop-blur-lg flex items-center justify-between shadow-xl cursor-pointer hover:border-indigo-500/40 transition-all hover:scale-[1.02] text-left animate-fade-in"
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-500 dark:text-slate-400 font-semibold mt-1">Challenge yourself, practice concepts, and climb the leaderboard!</p>
              </div>
            </div>
          ...
          {/* PYQ Arena Card */}
          <div className="flex-1 p-5 border border-amber-500/25 rounded-3xl bg-slate-900/60 dark:bg-slate-950/40 backdrop-blur-lg flex items-center justify-between shadow-xl cursor-pointer hover:border-amber-500/40 transition-all hover:scale-[1.02] text-left animate-fade-in"
               onClick={() => setCurrentView('pyq-dashboard')}>
            <div className="flex items-center gap-4">
              <div className="h-12 w-12 rounded-2xl bg-amber-500/20 text-amber-400 flex items-center justify-center border border-amber-500/30 shadow-inner">
                <GraduationCap className="w-6 h-6 text-amber-400" />
              </div>
              <div>
                <h3 className="text-sm font-black text-slate-900 dark:text-slate-100 flex items-center gap-2">
                  Previous Year Papers
                  <span className="text-[8px] uppercase tracking-wider font-extrabold px-1.5 py-0.5 rounded-md bg-amber-600 text-white">PYQ CBT</span>
                </h3>
                <p className="text-[10px] text-slate-500 dark:text-slate-400 font-semibold mt-1">Practice official board and competitive test past papers.</p>
              </div>
            </div>
