          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-black text-slate-900 dark:text-white flex items-center gap-2">
                ...
                <Badge variant="warning" className="text-[8px] tracking-wider uppercase font-black px-1.5 py-0.5 rounded-lg text-slate-950 border-none">PYQ WORKFLOW</Badge>
              </h2>
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 max-w-md leading-relaxed font-semibold">
                Select your parameters sequentially to view the Previous Year Question (PYQ) board papers.
              </p>
            </div>
          </div>
        </div>
            ...
            activeSubjects.length > 0 ? (
              <div className="relative">
                <select 
                  ...
                  className="w-full p-4 pr-10 rounded-2xl border border-slate-200 dark:border-slate-855 bg-white/70 dark:bg-slate-900/60 backdrop-blur-xl text-slate-800 dark:text-white outline-none text-xs font-bold shadow-lg focus:border-indigo-500 transition-all appearance-none cursor-pointer"
                >
